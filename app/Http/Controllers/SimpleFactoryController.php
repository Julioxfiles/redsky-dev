...
class SimpleFactoryController {
    ...
    public function payAction(Request $request) {
        ...
        $payment = PaymentSimpleFactory::make($method);
        /*
        if ($method == "card") {
            $payment = new CreditCardPayment();
        } elseif ($method == "paypal") {
            $payment = new PaypalAdapter(new PayPalPayment());
        } elseif ($method == "stripe") {
            $payment = new StripeAdapter(new StripePayment());
        } elseif ($method == "bitcoin") {
            $payment = new BitcoinAdapter(new BitcoinPayment());
        } 
        */
